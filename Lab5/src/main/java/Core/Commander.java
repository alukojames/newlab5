...
public class Commander {
    ...
    private boolean categorizeCommand(String[] userCommand) {
        switch (userCommand[0]) {
            ...
            case "add_if_max":
                if(userCommand.length == 1){
                    return !commandManager.addIfMax();
                }
                System.out.println("This command doesn't support argument!");
                return true;
            ...
            case "remove_greater":
                if(userCommand.length == 2){
                    return !commandManager.removeGreater(userCommand[1]);
                }
                System.out.println("This command doesn't support argument!");
                return true;
            ...
            case "print_field_ascending_distance":
                if(userCommand.length == 1){
                    return !commandManager.printFieldAscendingDistance();
                }
                System.out.println("This command doesn't support argument!");
                return true;
            ...
            case "print_unique_distance":
                if(userCommand.length == 2){
                    return !commandManager.printUniqueDistance(userCommand[1]);
                }
